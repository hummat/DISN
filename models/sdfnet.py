...
def get_sdf_basic2(src_pc, globalfeats, is_training, batch_size, num_point, bn, bn_decay, wd=None):
    net2 = tf_util.conv2d(tf.expand_dims(src_pc, 2), 64, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay,
    ...
    net2 = tf_util.conv2d(net2, 512, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay, bn=bn,
                          is_training=is_training,
    ...
    net2 = tf_util.conv2d(concat, 512, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay, bn=bn,
                          is_training=is_training,
                          weight_decay=wd, scope='fold2/conv1')
    net2 = tf_util.conv2d(net2, 256, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay, bn=bn,
                          is_training=is_training,
                          weight_decay=wd, scope='fold2/conv2')
    pred = tf_util.conv2d(net2, 1, [1, 1], padding='VALID', stride=[1, 1], activation_fn=None, bn=False,
                          weight_decay=wd, scope='fold2/conv5')
...
def get_sdf_basic2_binary(src_pc, globalfeats, is_training, batch_size, num_point, bn, bn_decay, wd=None):
    ...
    net2 = tf_util.conv2d(net2, 256, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay, bn=bn,
                          is_training=is_training,
                          weight_decay=wd, scope='fold2/conv2')
    pred = tf_util.conv2d(net2, 2, [1, 1], padding='VALID', stride=[1, 1], activation_fn=None, bn=False,
                          weight_decay=wd, scope='fold2/conv5_bi')
...
def get_sdf_basic2_imgfeat_onestream(src_pc, globalfeats, point_feat, is_training, batch_size, num_point, bn, bn_decay,
                                     wd=None):
    net2 = tf_util.conv2d(tf.expand_dims(src_pc, 2), 64, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay,
                          bn=bn, is_training=is_training,
                          weight_decay=wd, scope='fold1/conv1')
...
def get_sdf_basic2_imgfeat_onestream_binary(src_pc, globalfeats, point_feat, is_training, batch_size, num_point, bn,
                                            bn_decay, wd=None):
    net2 = tf_util.conv2d(tf.expand_dims(src_pc, 2), 64, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay,
                          bn=bn, is_training=is_training,
                          weight_decay=wd, scope='fold1/conv1')
...
def get_sdf_basic2_imgfeat_twostream_binary(src_pc, point_feat, is_training, batch_size, num_point, bn, bn_decay,
                                            wd=None):
    net2 = tf_util.conv2d(tf.expand_dims(src_pc, 2), 64, [1, 1], padding='VALID', stride=[1, 1], bn_decay=bn_decay,
                          bn=bn, is_training=is_training,
                          weight_decay=wd, scope='fold1/conv1')
